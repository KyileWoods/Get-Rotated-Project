...
linker.cmd: package/cfg/empty_min_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_min_pem4fcfg.cmd\)\"$""\"C:/Engineering/EmbeddedSystems/GroupProject/Get-Rotated-Project/Debug/configPkg/\1\""' package/cfg/empty_min_pem4f.xdl > $@
