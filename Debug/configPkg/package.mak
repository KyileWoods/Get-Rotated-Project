...
C:/Users/Sam/EGH456_Assignment_2023/Get-Rotated-Project/ToF_Assignment/Debug/configPkg/config.bld:
package.mak: C:/Users/Sam/EGH456_Assignment_2023/Get-Rotated-Project/ToF_Assignment/Debug/configPkg/config.bld
...
package/cfg/empty_min_pem4f.xdc.inc: package/cfg/empty_min_pem4f.xdl
package/cfg/empty_min_pem4f.xdl package/cfg/empty_min_pem4f.c: .interfaces
...
empty_min.xem4f: package/cfg/empty_min_pem4f.oem4f 
	...
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/empty_min_pem4f.oem4f   package/cfg/empty_min_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
...
clean,em4f::
	-$(RM) $(wildcard .tmp,empty_min.xem4f,*)
